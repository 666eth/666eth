...
contract Revolution is Accessibility, PaymentSystem {
  ...
  uint public constant maxBalance = 666e5 ether; // 66,600,000 eth
  uint public constant pauseOnNextWave = 168 hours;

  // percents
  Percent.percent private m_dividendsPercent = Percent.percent(666, 10000); // 666/10000*100% = 6.66%
  Percent.percent private m_adminPercent = Percent.percent(1, 10); // 1/10*100% = 10%
  Percent.percent private m_payerPercent = Percent.percent(0, 100); // 7/100*100% = 7%
